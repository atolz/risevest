...
const Testimonials = () => {
  ...
  return (
    <div className=" mt-20">
      <div className=" px-2 text-center flex flex-col items-center mx-auto mb-10">
...
const ReviewCard = ({ img, name, role, body }: { img: string; name: string; role: string; body: string }) => {
  return (
    <figure
      className={cn(
        "relative w-[300px] md:w-[400px] min-h-[238px] flex flex-col items-center md:items-start cursor-pointer overflow-hidden rounded-xl border p-4 [box-shadow:_0px_12px_24px_0px_hsla(184,_52%,_51%,_0.15)]",
        // light styles
