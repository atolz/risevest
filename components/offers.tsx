...
const Offers = () => {
  ...
  return (
    <div className=" container ">
      {offers.map((offer, i) => {
        return (
          <div className={cn("max-w-[1000px] mx-auto flex even:flex-row-reverse gap-24 lg:gap-32  items-center mb-16 sm:mb-16  ", isMobile && i == 3 ? "hidden" : "")} key={i}>
            ...
            <div className={cn("w-full md:w-1/2 flex flex-col items-center md:flex-row", offer?.imgConainerCN)}>
              <div className="relative mb-8 sm:mb-10 md:mb-0 md:scale-[.9]">
                <Image width={offer.width} height={offer.height} className={twMerge("-translate-y-2 h-[146px] sm:h-[200px] w-auto md:h-auto  ", offer?.imgCN)} alt="illustration" src={offer.src} />
